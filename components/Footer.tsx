...
export function Footer() {
  return (
    <footer className="relative z-10 mt-24 bg-ink text-paper">
      <div className="mx-auto max-w-[1400px] px-5 lg:px-10 pt-20 pb-10">
        ...
        <div className="mt-16 pt-8 border-t border-paper/15 flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-[0.82rem] text-paper/60">
